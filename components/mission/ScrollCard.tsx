      ...
      <View style={styles.detailsRow}>
        <View className="flex-row items-center flex-shrink-0">
          <MaterialCommunityIcons
            ...
            color="#6B7280"
          />
          <Text className="font-work-sans text-sm text-gray-500 ml-1" numberOfLines={2} style={styles.detailText}>
            {mission.location}
          </Text>
        </View>
